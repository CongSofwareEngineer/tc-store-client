  ...
  return (
    <div className='flex flex-col gap-2 justify-between'>
      ...
      <div className='flex flex-col gap-2 w-full'>
        ...
        <PasswordInput className='!pb-0' maxLength={15} type='password' value={passAgain} onChange={(e) => setPassAgain(e.target.value)} />
        <span className='text-xs text-red-600 h-4'>{isError && translate('warning.inValidPassWordAgain')}</span>
