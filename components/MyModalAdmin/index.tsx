...
const MyModalAdmin = () => {
	...
	return modalAdmin.body ? (
		<div onClick={onClick} className="fixed z-[9999999] flex justify-center items-center flex-col inset-0 w-[100dvw] h-[100dvh] bg-black/20 ">
			<div className={`md:w-[500px] w-[90dvw] animate-zoom  transition-all duration-500 relative flex flex-col justify-center items-center bg-white rounded-xl p-5 ${modalAdmin.className}`}>
