...
const Item = ({ icon, value, link }: any) => {
  return (
    <div className='flex gap-2 items-center'>
      <Image fill alt={`icon-footer-${value}`} src={icon} className='!relative md:!w-[25px] !w-[20px] md:!h-[25px] !h-[20px]' />
        ...
        <div className=' w-full max-w-[1350px] md:p-[50px] p-[20px]  pb-10 '>
          ...
          <div className='flex md:flex-row flex-col w-full justify-between md:gap-0 gap-4'>
            <div className='flex flex-col md:gap-3 gap-2 md:w-[48%] w-full'>
              <Item icon={images.footer.iconGmail} value={'hodiencong2000.@gmail.com'} link='mailto:hodiencong2000.@gmail.com' />
              <Item icon={images.footer.iconNumberPhone} value={'Hồ Diên Công'} link='tel:0392225405' />

              <Item icon={images.footer.iconZalo} value={'0392225405'} link='https://zalo.me/0392225405' type={'zalo'} />
              <Item icon={images.footer.iconFace} value={'Facebook'} link='https://www.facebook.com/profile.php?id=100080400793331' />
              <Item icon={images.footer.iconGithub} value={'CongSofwareEngineer'} link='https://github.com/CongSofwareEngineer' />
              <Item
