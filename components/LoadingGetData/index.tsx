...
const LoadingGetData = ({ loading = false, colDesktop = 4, colSurface = 4, colMobile = 2, colTablet = 3, minWidthSurface = 1024, minWidthMobile = 568, minWidthTablet = 768, rows = 1, children }: Props) => {
